...
<style type="text/css"> 
        label { width: 10em; } 
        label.haha {color: red; padding-left: 18px; vertical-align: top;width: 196px; background: url("js/image/error.gif") no-repeat;} 
        input.haha { border: 1px solid red; } 
        label.valid {background: url("js/image/ok.gif") no-repeat; color: #065FB9;} 
	  ...
	  $("#registerForm").validate({
	      ...
	      success: function(label) {   
		   ...
		   rules:{
			   ...
			   checkcode:{
				   required:true,
				   remote:"UserServlet?m=validCode"
			   }
		...
		<div class="span24">
			<div class="wrap">
				<div class="main clearfix">
					...
					<form id="registerForm" action="${ pageContext.request.contextPath }/UserServlet?m=regist"  method="post" novalidate="novalidate">
						<table>
							<tbody><tr>
								<th>
							...
							<tr>
								...
								<tr>
									...
									<td>
										<span class="fieldSet">
											<input type="text" id="checkcode" name="checkcode" class="text captcha" maxlength="4" autocomplete="off"/><img id="checkImg" class="captchaImage" src="${pageContext.request.contextPath}/ValidCodeServlet" onclick="this.src='ValidCodeServlet?time='+new Date().getTime()" title="点击更换验证码"/>
										</span>
									</td>
								</tr>
							<tr>
...
<div class="ad">
	...
	<dd>
		自由退换、售后上门
								...
								<dd>
									立即登录即可体验在线购物！
									<a href="${pageContext.request.contextPath}/user_loginUI">立即登录</a>
								</dd>
							</dl>
						</div>
					</form>
